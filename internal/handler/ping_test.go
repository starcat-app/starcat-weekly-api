...
func TestHandlePingV1_OK(t *testing.T) {
	...
	if env.Data.Service != "weekly" {
		t.Errorf("data.service: want 'weekly', got %q", env.Data.Service)
	}
...
func TestHandlePingV1_ServiceNamePassthrough(t *testing.T) {
	cases := []string{"weekly", "weekly", "sharing", "wiki", "custom-fork"}
